...
public class VelocityUtils
{
    ...
    public static void setMenuVelocityContext(VelocityContext context, GenTableDto genTable)
    {
       ...
       // JSONObject paramsObj = JSONObject.parseObject(options);
        ...
        {
            Map<String, Object> paramsObj = JacksonUtils.convertJson2Map(options);
    ...
    public static void setTreeVelocityContext(VelocityContext context, GenTableDto genTable)
    {
        ...
        if (StringUtils.isNotBlank(options))
        {
            ...
            {
                context.put("tree_parent_code", paramsObj.get(GenConstants.TREE_PARENT_CODE).toString());
            }
            if (paramsObj.containsKey(GenConstants.TREE_NAME))
            {
                context.put("tree_name", paramsObj.get(GenConstants.TREE_NAME).toString());
            }
        }
    ...
    public static String getTreecode(Map<String,Object> paramsObj)
    {
        ...
        {
            return StrUtil.toCamelCase(paramsObj.get(GenConstants.TREE_CODE).toString());
        }
    ...
    public static String getTreeParentCode(Map<String,Object> paramsObj)
    {
        if (paramsObj.containsKey(GenConstants.TREE_PARENT_CODE))
        {
            return StrUtil.toCamelCase(paramsObj.get(GenConstants.TREE_PARENT_CODE).toString());
        }
        return StrUtil.EMPTY;
    }
    ...
    public static String getTreeName(Map<String,Object> paramsObj)
    {
        if (paramsObj.containsKey(GenConstants.TREE_NAME))
        {
            return StrUtil.toCamelCase(paramsObj.get(GenConstants.TREE_NAME).toString());
        }
        return StrUtil.EMPTY;
    }
